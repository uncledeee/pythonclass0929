...
use cryptomarket;
create table itemlist(id int primary key not null, symbol VARCHAR(250) not null, lastprice float not null,
changee float not null, percentchangee float not null);
INSERT INTO itemlist (ID, SYMBOL, LASTPRICE, CHANGEE, PERCENTCHANGEE) VALUES
(1,'BTC USD','16,958.99','-130.93','-0.77%'),
(2,'ETH USD','1,275.62','-5.75','-0.45%'),
